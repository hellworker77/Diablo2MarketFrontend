...
export class GetInProgressDealsRequestManager extends AbstractPageableRequestManager<DealType, Page> {
    ...
    protected readonly url = BaseEndpoint + "Deal/inProgressDealsChunk"
