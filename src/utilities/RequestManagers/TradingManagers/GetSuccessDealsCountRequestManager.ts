...
export class GetSuccessDealsCountRequestManager extends AbstractRequestManager<number, Params>{
    ...
    protected readonly url = BaseEndpoint + "Deal/successDealsCount";
}